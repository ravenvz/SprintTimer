...
using sprint_timer::SprintTimer;
...
// class WorkflowTMock : public sprint_timer::TimerWorkflow {
// public:
...
//     MOCK_METHOD(void,
//                 addListener,
//                 (TimerWorkflow::WorkflowListener*),
//                 (override));
//
//     MOCK_METHOD(void,
//                 removeListener,
...
//     MOCK_METHOD(void,
//                 reconfigure,
//                 (const TimerWorkflow::WorkflowParams&),
//                 (override));
// };
...
public:
    ...
    //                 GoalProgress::Estimated{12},
    //                 GoalProgress::Actual{7}}}}));
    // }
};

TEST_F(TimerPresenterFixture, rewire_through_api) { FAIL(); }
...
// removes_self_as_workflow_listener_when_destroyed)
// {
...
//             {GoalProgress{GoalProgress::Estimated{14},
//             GoalProgress::Actual{2}},
...
//
// TEST_F(TimerPresenterFixture,
// displays_idle_ui_when_workflow_enters_idle_state)
// {
//     presenter.attachView(view);
//
//     EXPECT_CALL(view, setupUi(TimerUiModel::idleUiModel("Start")));
//
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::Idle);
// }
//
// TEST_F(TimerPresenterFixture, displays_submission_ui_when_sprint_ends)
// {
//     taskSelectionMediator.changeSelection(&taskSelectionColleague,
//                                           TaskDTO{someTask});
//     presenter.attachView(view);
//
//     EXPECT_CALL(view, selectTask(std::optional<std::string>{someTask.uuid}));
//     EXPECT_CALL(view,
//     setupUi(TimerUiModel::sprintFinishedUiModel("Submit")));
//
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::SprintFinished);
// }
//
...
//     ON_CALL(workflow,
//     currentDuration()).WillByDefault(Return(sprintDuration));
//     presenter.attachView(view);
//
//     EXPECT_CALL(view,
...
//
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::RunningSprint);
// }
//
...
//     presenter.attachView(view);
//     ON_CALL(workflow,
//     currentDuration()).WillByDefault(Return(breakDuration));
//
//     EXPECT_CALL(view,
//                 setupUi(TimerUiModel::runningUiModel(
//                     breakDuration, std::string{brakeStateColor}, false)));
//
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::BreakStarted);
// }
//
// TEST_F(TimerPresenterFixture,
...
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::SprintFinished);
//     ON_CALL(workflow,
//     completedSprints()).WillByDefault(Return(timeIntervals));
//
...
//
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::ZoneEntered);
// }
//
...
//
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::ZoneLeft);
// }
//
...
//
//     presenter.onWorkflowStateChanged(TimerWorkflow::StateId::BreakFinished);
// }
//
