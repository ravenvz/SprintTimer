...
**
*********************************************************************************/
#ifndef PLANNERTREEWIDGET_H_J7NWH1NH
#define PLANNERTREEWIDGET_H_J7NWH1NH
...
class PlannerTreeWidget : public QWidget,
                          public contracts::PlannerContract::View {
public:
    PlannerTreeWidget(QAbstractItemModel& plannerModel_,
...
#endif /* end of include guard: PLANNERTREEWIDGET_H_J7NWH1NH */
