...
PlannerTreeWidget::PlannerTreeWidget(QAbstractItemModel& plannerModel_,
    ...
    , editTaskDialog{editTaskDialog_}
{
    ...
    connect(this,
            ...
            this,
            &PlannerTreeWidget::showContextMenu);
...
auto PlannerTreeWidget::handleEdit(const QModelIndex& index) const -> void
{
...
auto PlannerTreeWidget::handleToggle(const QModelIndex& index) const -> void
{
    alg::inspect(presenter(), [&](auto* presenter) {
...
auto PlannerTreeWidget::displayPlanner(
...
auto PlannerTreeWidget::showContextMenu(const QPoint& pos) const -> void
{
...
auto PlannerTreeWidget::selectedTaskUuid() const -> std::string
{
