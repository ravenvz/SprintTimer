...
std::optional<sprint_timer::api::WorkdayStatisticsDTO>
...
WorkdayStatisticsHandler::handle(const WorkdayStatisticsQuery& query)
{
...
computeStatistics(const std::vector<dw::DateTimeRange>& sprintIntervals,
                  const dw::DateRange& dateRange)
{
    using sprint_timer::api::WorkdayStatisticsDTO;
