...
class DailyStatisticsHandler : public asp::QueryHandler<DailyStatisticsQuery> {
public:
    using request_statistics_handler_t =
        asp::QueryHandler<SprintStatisticsQuery>;
    using work_schedule_handler_t = asp::QueryHandler<WorkScheduleQuery>;
    ...
    DailyStatisticsQuery::Result
    handle(const DailyStatisticsQuery& query) override;
