...
class ChangeActiveTasksPriorityHandler
    : public asp::CommandHandler<ChangeActiveTasksPriorityCommand> {
public:
    ChangeActiveTasksPriorityHandler(TaskStorageWriter& writer,
                                     ActionInvoker& actionInvoker);

    void handle(const ChangeActiveTasksPriorityCommand& command) override;
