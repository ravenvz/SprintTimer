...
class WorktimeStatisticsHandler
    : public asp::QueryHandler<WorktimeStatisticsQuery> {
public:
    ...
    WorktimeStatisticsQuery::Result
    handle(const WorktimeStatisticsQuery& query) override;
