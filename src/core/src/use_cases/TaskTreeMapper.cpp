...
sprint_timer::use_cases::TaskTypeDTO
makeTaskTypeDTO(sprint_timer::TaskType taskType)
{
...
fromTaskTypeDTO(const sprint_timer::use_cases::TaskTypeDTO& taskType)
{
    using namespace sprint_timer;
    using enum sprint_timer::use_cases::TaskTypeDTO;
