...
inline sprint_timer::use_cases::TaskTreeDTO buildSampleTree()
{
    using sprint_timer::use_cases::TaskDTO;
    using sprint_timer::use_cases::TaskNodeDTO;
    using sprint_timer::use_cases::TaskTypeDTO;
    using namespace dw;
...
ReadTaskTreeQuery::result_t
ReadTaskTreeHandler::handle(ReadTaskTreeQuery&& /*query*/)
{
