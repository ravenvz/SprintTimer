...
class QtOperationalRangeReader : public api::OperationalRangeReader {
public:
    QtOperationalRangeReader(QString connectionName,
    ...
    auto
    operator=(QtOperationalRangeReader&&) -> QtOperationalRangeReader& = delete;
