...
**
*********************************************************************************/
#include "qt_gui/widgets/ExtraDayListView.h"
...
ExtraDayListView::ExtraDayListView(QWidget* parent)
    : QListView{parent}
{
    ...
    connect(this,
            ...
            this,
            &ExtraDayListView::showContextMenu);
}

void ExtraDayListView::showContextMenu(const QPoint& pos)
{
